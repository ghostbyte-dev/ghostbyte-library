...
export default function HeroSection() {
    ...
    return (
        <section className="relative py-16 overflow-hidden">
                      {/* Decorative elements */}
                      <div className="absolute -left-20 top-10 h-64 w-64 rounded-full bg-purple-600/10 blur-3xl"></div>
                      <div className="absolute right-20 top-40 h-40 w-40 rounded-full bg-cyan-500/10 blur-3xl"></div>
                      <div className="absolute left-40 bottom-0 h-60 w-60 rounded-full bg-violet-500/10 blur-3xl"></div>
                      ...
                      <div className="relative z-10 max-w-4xl mx-auto text-center">
                        ...
                        <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
                          An ever-growing collection of useful websites, hidden gems, and essential online tools for creators and
                          developers.
                        </p>
                        ...
                        <div className="flex justify-center">
                          <button className="bg-gradient-to-r from-purple-600 to-violet-500 hover:from-purple-700 hover:to-violet-600 group">
